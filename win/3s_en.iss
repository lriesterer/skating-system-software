...
[Files]
Source: "3s_en.exe"; DestDir: "{app}"; DestName: "3s.exe"; CopyMode: alwaysoverwrite
...
Source: "F:\example_adv_en.ska"; DestDir: "{app}"; DestName: "example_advanced.ska";  CopyMode: alwaysoverwrite
