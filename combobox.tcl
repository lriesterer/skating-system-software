...
#  $Id: combobox.tcl,v 1.5 1999/05/20 15:45:32 eric Exp $
# ------------------------------------------------------------------------------
#  Index of commands:
#     - ComboBox::create
#     - ComboBox::configure
...
proc ComboBox::_create_popup { path } {
    ...
    set frame  [frame $shell.frame -relief flat -bg black -bd 1]
    set listb  [listbox $shell.listb -relief flat -bd 0 -highlightthickness 0 \
					...
					-selectbackground [Widget::getoption $path -selectbackground] \
					-selectborderwidth [Widget::getoption $path -selectborderwidth] \
					-bg [Widget::getoption $path -entrybg]]

    if { $sb } {
	set scroll [scrollbar $shell.scroll \
		-orient vertical \
		-command "$shell.listb yview" \
		-highlightthickness 0 -takefocus 0 -width 9 -bd 1]
